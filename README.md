...
- Python `requirements.txt` (detect license name and license type)
...
- Any CSV files with package name and license name columns (detect license type).
...
jobs:
  license_check:
    ...
    - name: Check python
      id: license_check_report
      uses: pilosus/action-pip-license-checker@v0.4.0
      with:
